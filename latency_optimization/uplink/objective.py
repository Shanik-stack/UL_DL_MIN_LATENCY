...
from .uplink_rate_model import evaluate_uplink_rate_torch


class FiniteBlocklengthRateObjective(nn.Module):
    def __init__(
        self,
    ...
    def forward(self, precoder: torch.Tensor):
        ...
        return (
            ...
            power_gap,
            torch.relu(rate_gap),
            torch.relu(power_gap),
        )


__all__ = ["FiniteBlocklengthRateObjective"]
