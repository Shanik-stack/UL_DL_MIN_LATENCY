"""Run one complete uplink convergence experiment.
...
from .optimize_transmission import run_convergence_baseline
...
def run_convergence_experiment(
    ...
    *,
    ...
    """
    # ALGORITHM 1: Load one validated experiment definition.
    # The same system parameters and seed are reused for baseline and optimized systems.
    ...
    # ALGORITHM 2: Measure the two reference schedules before optimization.
    # The random adaptive-n reference and random full-T reference share this channel seed.
    baseline_builder = (
        estimate_initial_random_precoder_streaming_schedule
    ...
    # ALGORITHM 3: Preserve an untouched simulator on which the accepted solution is committed.
    ...
    # REPORTING: Record the initial physical configuration; this does not affect optimization.
    if do_plots:
    ...
    # ALGORITHM 4: Run the complete online allocation algorithm.
    # This call selects payload/streaming behavior, optimizes each user beam, and searches n_kl.
    ...
    # ALGORITHM 5: Commit the accepted precoders and blocklengths to the reporting simulator.
    apply_training_solution(report_system, convergence_data["n_star"], convergence_data["F_star"])

    # RESULTS: Combine the optimized schedule, references, diagnostics, and runtime accounting.
...
def main() -> None:
    # ENTRY 1: Parse only command-line concerns here; the algorithm lives above.
    ...
    # ENTRY 2: Resolve the configuration-dependent result identity and output directories.
    ...
    # ENTRY 3: Execute the complete experiment. Quiet mode redirects only console output.
    ...
    # OUTPUT 1: Adapt the canonical result into the legacy text/plot input shapes.
    ...
    # OUTPUT 2: Persist detailed numerical schedules before generating derived figures.
    ...
    # OUTPUT 3: Generate optimization, latency, link-quality, and schedule diagnostics.
    plot_optimization_result(
    ...
    # OUTPUT 4: Save the canonical machine-readable result, human summary, and run manifest.
