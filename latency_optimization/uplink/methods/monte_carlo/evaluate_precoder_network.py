"""Evaluate trained uplink precoder networks without updating their weights."""
...
from ...physics.rate import build_uplink_rate_covariance_torch, uses_uplink_interference
...
from .build_training_rollouts import (
