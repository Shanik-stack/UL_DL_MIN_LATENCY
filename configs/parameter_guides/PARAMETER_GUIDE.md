...
- `monte_carlo_test_seed`: first candidate seed for the held-out dataset.
  Training seeds are excluded automatically.
...
- `monte_carlo_test_n_search_direction`: held-out evaluation search direction.
- `monte_carlo_test_n_search_strategy`: held-out evaluation search strategy.
- `monte_carlo_test_n_search_coarse_step`: held-out coarse-to-fine increment.
- `monte_carlo_test_n_search_exponential_factor`: held-out exponential spacing
  factor.
